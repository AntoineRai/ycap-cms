      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormControl>
                <Input type="text" placeholder="Nom du quartier" {...field} className="w-1/2"/>
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormControl>
                <Textarea placeholder="Description" {...field} className="w-1/2 max-h-[200px]"/>
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
